...
@section('content')
    <div class="py-10">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <!-- Heading -->
            <h1 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-2">Aset Master</h1>
            <h3 class="text-base font-medium text-gray-600 dark:text-gray-300 mb-6">
                Aset Master yang akan digunakan untuk mengisi Aset di Ruangan.
            </h3>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
                <!-- Left: Search -->
                <form action="{{ route('aset.index') }}" method="GET" class="max-w-sm w-full">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-300 dark:bg-gray-900">
                            <tr>
                                <th scope="col"
                                    class="px-4 py-3 text-start text-xs font-semibold text-gray-700 dark:text-gray-200">
                                    No
                                </th>
                                <th scope="col"
                                ...
                                <th scope="col"
                                    class="px-4 py-3 text-center text-xs font-semibold text-gray-700 dark:text-gray-200">
                                    Aksi Admin
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($asets as $index => $aset)
                                <tr
                                    ...
                                    <td class="px-6 py-3 text-sm text-center text-gray-900 dark:text-gray-100">
                                        {{ $aset->nama_aset }}
                                    </td>
                                    <td class="px-6 py-3 text-sm text-center text-gray-900 dark:text-gray-100">
                                        {{ $aset->tipe_aset }}
                                    ...
                                    <td class="px-4 py-3 text-sm text-center flex justify-center gap-2">
                                        ...
                                        <a href="{{ route('aset.edit', Crypt::encrypt($aset->id)) }}"
                                            class="px-2 rounded-lg text-gray-600 hover:text-green-600 dark:text-gray-300 dark:hover:text-green-400">
                                            <x-icon-edit />
                                        </a>
                                        <!-- Delete -->
